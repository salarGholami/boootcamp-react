  ...
  return (
    <tbody>
      <tr className="bg-white border-b text-xs dark:bg-gray-800 dark:border-gray-700">
        ...
        <td className="px-6 py-4 justify-start items-center flex">
          {item.status === "OPEN" ? (
            <p className="bg-green-800 text-white px-5 py-1 rounded-xl">باز</p>
          ) : (
            <p className="bg-red-800 text-white px-3 py-1 rounded-xl">بسته</p>
          )}
        </td>
